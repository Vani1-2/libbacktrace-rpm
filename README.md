# libbacktrace (Packaged in `.rpm`)

> **⚠️ Note:** This is a fork of [ianlancetaylor/libbacktrace](https://github.com/ianlancetaylor/libbacktrace) maintained for **RPM packaging purposes**.
> It includes `libbacktrace.spec` and `.copr/Makefile` to facilitate building on Fedora/RHEL and Copr, specifically to serve as a dependency for the packaging of **[Extension Manager](https://github.com/mjakeman/extension-manager)**.
> If you are looking for the original source code, please visit the [upstream repository](https://github.com/ianlancetaylor/libbacktrace).
...
Initially written by Ian Lance Taylor [iant@golang.org](mailto:iant@golang.org).
